      ...
      <div className="row mt-4">
        ...
        <div className="col-8 d-flex justify-content-end">
          <Card style={{ width: "18rem" }}>
            ...
            <Card.Body>
              <Card.Title>Santiago Ourthe Cabalé 
</Card.Title>
            </Card.Body>
            ...
            <Card.Body>
              <div className="icons">
                <FontAwesomeIcon
                  ...
                  icon={faSquareFacebook} size="2x"
                />

                <a href="#">
                  <FontAwesomeIcon className="black-icon" icon={faInstagram} size="2x" />
                </a>
                <a href="#">
                  <FontAwesomeIcon className="black-icon" icon={faXTwitter} size="2x"/>
                </a>
                <a href="#">
                  <FontAwesomeIcon className="black-iconT" icon={faTiktok}size="2x" />
                </a>
              </div>
            </Card.Body>
          </Card>
